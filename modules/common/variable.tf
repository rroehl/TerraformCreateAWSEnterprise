		...
		object({   										#Region contents
            ...
            region_managed_CIDR_list_info =   map(     	# CIDR 
                object({                                # CIDR Lists
                    ...
                    cidr_list_uuid = string             # CIDR List UUID
				...
				/*	vpc_instance_tenancy = string
                    ...
                    network_acls_list_info =   map(     	    # VPC network acls
                        object({                                # network acls Lists   
                            description = string    
                            netacl_uuid = string  //Network Acl UUID
  ...
  default =  {
        ...
        us-west-2 = { # Region
            ...
            region_managed_CIDR_list_info = {
                ...
                ProdPublicVPC_CIDRlist  = {
                   address_family = "IPv4"
                   cidr_list_uuid = "d496c4a9-7bc2-41ad-9fa4-f1f8848fbefd"
                   max_entries = 4
                   cidr_entries = {
                       entry1 = {
                ...
                ProdVPC_CIDRlist  = {
                   address_family = "IPv4"
                   cidr_list_uuid = "635c1df2-af1f-4d85-9f2a-13c3b6171529"
                   max_entries = 5
                   cidr_entries = {
                       entry1 = {
                ...
                TestVPC_CIDRlist  = {
                   address_family = "IPv4"
                   cidr_list_uuid = "001b4600-81db-4d56-8f86-37c3aff982ed"
                   max_entries = 5
                   cidr_entries = {
                       entry1 = {
                            cidr_entry = "10.54.127.0/24"
                ...
                SharedServersVPC_CIDRlist  = {
                   address_family = "IPv4"
                   cidr_list_uuid = "2bf1d4b1-ead3-4d42-b821-8a34486e3525"
                   max_entries = 5
                   cidr_entries = {
                       entry1 = {
                            cidr_entry = "10.54.127.0/24"
                ...
                SandboxVPC_CIDRlist  = {
                   address_family = "IPv4"
                   cidr_list_uuid = "6351b6cb-f34a-4758-abdf-8bfe4e842da6"
                   max_entries = 5
                   cidr_entries = {
                       entry1 = {
                            cidr_entry = "10.54.127.0/24"
        ...
        us-east-2 = { # Region
            ...
            region_managed_CIDR_list_info = {
                ...
                ProdPublicVPC_CIDRlist  = {
                   address_family = "IPv4"
                   cidr_list_uuid = "14abebc5-cd6d-4122-b0ca-f1b4a411799c"
                   max_entries = 12
                   cidr_entries = {
                       entry1 = {
                ...
                ProdPrivateVPC_CIDRlist  = {
                    address_family = "IPv4"
                    cidr_list_uuid = "669550d9-77fc-4209-8a22-1c74096be0b1"
                    max_entries = 14
                    cidr_entries = {
                       entry1 = {
                ...
                ProdNetworkVPC_CIDRlist  = {
                   address_family = "IPv4"
                   cidr_list_uuid = "3b55cc76-8241-43b0-b503-b8891cc7a373"
                   max_entries = 11
                   cidr_entries = {
                       entry1 = {
			...
			vpc_info = {
                    ...
                    vpc_cidr_block_list_info = { //Additional VPC CIDRs
                     ...
                     network_acls_list_info = {  // These are the network accles for the VPC
                        ...
                        Private_network_acls = {
                            ...
                            netacl_uuid = "d5d8fea7-19ce-411c-b449-06682263fc4f"  //Network Acl UUID
                        ...
                        Network_network_acls = {
                            ...
                            netacl_uuid = "4d9f3a49-60af-4c04-83b1-8ef42daee93d"  //Network Acl UUID
				...
				TestVPC = {  # VPC
                    ...
                    network_acls_list_info = {  // These are the network acls for the VPC
                        Public_network_acls = {  // 
                            ...
                            netacl_uuid = "398a9f05-3406-4bc0-a554-c379aff948f0"  //Network Acl UUID
                            subnet_type = "Public"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                        ...
                        Private_network_acls = {
                            ...
                            netacl_uuid = "c19b5376-1256-4bfb-b125-759eafe61ae4"  //Network Acl UUID
                            subnet_type = "Private"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                        ...
                        Network_network_acls = {
                            ...
                            netacl_uuid = "be693797-9c7e-49c6-986c-99e189d89a63"  //Network Acl UUID
                            subnet_type = "Network"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
				...
				DevVPC = {   # VPC
                    ...
                    network_acls_list_info = {  // These are the network acls for the VPC
                        Public_network_acls = {  // 
                            ...
                            netacl_uuid = "aaf2d004-9416-4367-b502-29f8b69aebb1" //Network Acl UUID
                            subnet_type = "Public"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                        ...
                        Private_network_acls = {
                            ...
                            netacl_uuid = "bcec5a94-cc3e-4d31-b167-60fc3ddc0f18"  //Network Acl UUID
                            subnet_type = "Private"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                        ...
                        Network_network_acls = {
                            description = "For test VPC, this will route all traffic between the network networks in the VPC"
                            netacl_uuid = "a3778946-9c3c-4533-85b4-07916ea9d8de"  //Network Acl UUID
                            subnet_type = "Network"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                ...
                SharedServiceVPC = {   # VPC
                    ...
                    network_acls_list_info = {  // These are the network acls for the VPC
                        Public_network_acls = {  // 
                            ...
                            netacl_uuid = "1eec67ce-e137-4706-8859-7bd9e1c24a44"  //Network Acl UUID
                            subnet_type = "Public"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                        ...
                        Private_network_acls = {
                            ...
                            netacl_uuid = "9ed41390-6f0b-4951-9774-bf8c8d81b1ff"  //Network Acl UUID
                            subnet_type = "Private"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                                ingress_rule1 = { //Allow all traffic inbound from other private networks in the Dev VPC
                                    protocol   = "-1"
                        ...
                        Network_network_acls = {
                            description = "For test VPC, this will route all traffic between the network networks in the VPC"
                            netacl_uuid = "c9a4c667-52e7-4531-a676-5ceefdc82d57"  //Network Acl UUID
                            subnet_type = "Network"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                ...
                SandBoxVPC = {   # VPC
                    ...
                    network_acls_list_info = {  // These are the network acls for the VPC
                        Public_network_acls = {  // 
                            description = "For SharedService VPC, this will route all traffic between the public networks in the VPC"
                            netacl_uuid = "35960dd3-100a-4c3e-a910-ecda92bfb4b6"  //Network Acl UUID
                            subnet_type = "Public"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                                ingress_rule1 = { //Allow all traffic inbound from other public networks in the SharedService VPC
                                    protocol   = "-1"
                        ...
                        Private_network_acls = {
                            description = "For SharedService VPC, this will route all traffic between the private networks in the VPC"
                            netacl_uuid = "eb164373-a4a7-4c56-872d-c0256f6ca799"  //Network Acl UUID
                            subnet_type = "Private"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                                ingress_rule1 = { //Allow all traffic inbound from other private networks in the Dev VPC
                                    protocol   = "-1"
                        ...
                        Network_network_acls = {
                            description = "For test VPC, this will route all traffic between the network networks in the VPC"
                            netacl_uuid = "66508486-1a5c-454f-ba41-c94dbbc03d68"  //Network Acl UUID
                            subnet_type = "Network"  //Has to match the subnet type name on the subnet
                            ingress_obj_list = {  // 
                                ingress_rule1 = { //Allow all traffic inbound from other network networks in the SharedService VPC
                                    protocol   = "-1"
